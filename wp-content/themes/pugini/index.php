 ...
 */
 ...
 get_header(); ?>
<?php 
	$home_title = get_theme_mod( 'pugini_home_title' );
	$home_text = get_theme_mod( 'pugini_home_text' );
	if ( !empty( $home_title ) || !empty( $home_text ) ) { 
?>
<section class="home_text text-center col-lg-12 col-md-12 col-sm-12">
	<?php if ( !empty( $home_title ) ) { ?>
		<h2><?php echo esc_html( $home_title ); ?></h2>
	<?php } ?>
